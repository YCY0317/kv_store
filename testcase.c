...
void array_testcase(int connfd) {
	...
	test_case(connfd, "SET Name YCY", "SUCCESS", "SETCase");
	test_case(connfd, "GET Name", "YCY", "GETCase");
	test_case(connfd, "MOD Name KKK", "SUCCESS", "MODCase");
	test_case(connfd, "GET Name", "KKK", "GETCase");
...
// ./testcase -s 192.168.3.158 -p 8888 -m 1
